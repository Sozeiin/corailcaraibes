-- Corriger les fonctions qui utilisent 'workflow' comme type d'alerte
-- Remplacer par 'system' qui est une valeur valide de l'enum alert_type
  ...
  IF NEW.quantity > OLD.quantity THEN
    ...
    IF matched_count > 0 THEN
      INSERT INTO public.alerts (
        ...
        'system', -- Utiliser 'system' au lieu de 'workflow'
        'info',
