-- Vérifier et corriger la fonction add_order_items_to_stock
-- Il pourrait y avoir un problème avec les permissions ou la logique

-- Mettre à jour la fonction pour mieux gérer les erreurs
