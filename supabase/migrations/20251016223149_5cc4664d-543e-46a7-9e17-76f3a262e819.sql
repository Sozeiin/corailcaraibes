-- Corriger la fonction delete_boat_cascade - supprimer la référence à thread_id
...
BEGIN
  ...
  -- 17. Supprimer messages liés aux topics de ce bateau (si la table existe et a la bonne structure)
