-- Improve the add_item_by_scan function with better error handling and logging
...
BEGIN
  ...
  IF p_package_code IS NOT NULL THEN
    ...
    IF NOT FOUND THEN
      INSERT INTO shipment_packages (shipment_id, package_code)
      VALUES (p_shipment_id, p_package_code)
      RETURNING id INTO v_package_id;
      
      RAISE LOG 'Created new package: % for shipment: %', p_package_code, p_shipment_id;
    END IF;
  END IF;
