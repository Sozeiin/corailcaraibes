-- Fix the link_stock_scan_to_supply_request function by removing manual total_cost calculation
...
BEGIN
  ...
  -- Create purchase history entry (let database calculate total_cost automatically)
