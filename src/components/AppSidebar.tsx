...
import { BarChart3, Ship, Users, Package, Wrench, ShoppingCart, Settings, ChevronDown, Truck, AlertTriangle, FileText, Clock, Anchor } from 'lucide-react';
...
const menuItems = [{
  ...
  url: '/checkin-checkout-management',
  icon: Anchor,
  roles: ['direction', 'chef_base']
}, {
  title: 'Paramètres',
