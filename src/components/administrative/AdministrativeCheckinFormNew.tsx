...
import { parseDateInputToUTC, getBaseTimezone } from '@/lib/dateUtils';
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert([{
          ...
          planned_start_date: parseDateInputToUTC(startDate, getBaseTimezone(user.timezone)).toISOString(),
          planned_end_date: parseDateInputToUTC(endDate, getBaseTimezone(user.timezone)).toISOString(),
